    ...
    renderShareButtons() {
        return (
            ...
            {this.props.activeSong.soundcloud_track_id ?
              <a target="_blank" href={`https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/${this.props.activeSong.soundcloud_track_id}`} className="source soundcloud">
            ...
            {this.props.activeSong.youtube_track_id ?
              <a target="_blank" href={`https://www.youtube.com/watch?v=${this.props.activeSong.youtube_track_id}`} className="source youtube">
