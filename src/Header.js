      ...
      <div className="headerContainer">
        ...
        <Link id="headerLogo" to="/"><img src="https://rockwiththis.info/wp-content/uploads/2017/09/logo_horiz_wh.png" /></Link>
          <div className="socialLinks">
    				...
    				<a target="_blank" href="https://www.instagram.com/rockwiththismusic/"><i class="fa fa-instagram" aria-hidden="true"></i></a>
    				<a target="_blank" href="https://open.spotify.com/user/jaredp21/playlist/2eWK5PGSTEl8I5ZvMG5VPS"><i class="fa fa-spotify" aria-hidden="true"></i></a>
