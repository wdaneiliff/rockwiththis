        ...
        <div className="player-controls-wrapper">
          <div className="player-controls">
            <div className="player-controls-buttons">
              <div id="player-control-button-back" className="player-control-button"></div>
              <div id="player-control-button-play" className="player-control-button"></div>
              <div id="player-control-button-next" className="player-control-button"></div>
            </div>
